...
Exactly what we have now. Coaching centres fill that gap, because the gap was created deliberately or not as a result of the implementation of the education system. As a result, we have many specialists (e.g., engineers) who don't know how the world functions currently & how it reached the current stage, & we have political science graduates who don't know how a turbine works. Both are fragmented. Both can be manipulated for blind & unearned loyalty. After that, the narratively engineered culture of individualism prevents synergy & coming together as a unified force to dismantle lies & seek the truth.

If one looks at statistics, the coaching market in India is massive (JEE, NEET, UPSC, SSC, other government jobs, etc.) at over Rs. 58,000 crore. It is easy to blame it on the institutes & the parents, but that would be blaming the facilitators & pawns instead of the systemic flaw in the desifn. The flaw of an incomplete education focused on specialization is what facilitates this gap to rise in the first place, which is then filled by coaching institutes. For this to be changed for benefit of students, two things need to be changed, both the coaching centres & the exam structures.

When it's about clearing competitive exams, it becomes about competition, about doing better than the next person. But holistic growth doesn't happen that way. It is not division that is needed for that, it is integration that is needed right now. 
...
The bell rings, the students sit in the classrooms, attending one class after another, without time to wonder. Jumping from assignment to assignment, solving a practice sheet after another, all in the hope of clearing a competitive exam & securing a future. There isn't an inherent fault in it, it's the protective element of human nature, but weaponized against the students. The daily life becomes so exhausting within this structure that the image of freedom becomes distant, while the heart yearns for it. That creates a cognitive dissonance, & gradually, the distance between reality & perception widens. That induces restlessness & seeing no end to it, the mind treats it as helplessness. Then it drowns itself in vices & grows even more restless. Over time, the person becomes bitter & hollow & suppresses the same will in others that they once had in themselves.

The fault isn't entirely with individualism, but more with the way it is implemented & propagated. From childhood, we're pushed into the perpetual fear of performing in exams, otherwise, we'll be left behind. That, if happens, is a systemic failure, but it is treated as an individual failure, & even if it is considered as a systemic failure, there exist no demedies for it currently. That is another reason why a reform is needed. 

If somehow we get lucky in terms of parents who give us the freedom to not worry about exams after a certain extent, we burn that image of desperation into our minds through peer pressure.

The real issue isn't population either. It is the misallocation of resources towards things of show & to maintain the illusion of power rather than facilitating real, progressive strength.
...
Before we go ahead, let's go back to the time when we were taught 3D geometry first. How amazing it felt to imagine a line moving across the classroom in 3 dimensions, crossing the benches & remaining unfazed by the collision. Where is that joy in institutionalized JEE coaching?
Reimagine the interest in history when we were being taught about the battle of Haldighati or the 1857 Revolt of Mangal Pandey & Rani Laxmibai, & how exciting it seemed. Where does that joy go away in UPSC coaching?
The joy goes away because we (propagated by the system) are so focused on immediate results that we tend to ignore the process, while the process is what gives the results, or sometimes it gives learnings that lead to another breakthrough. We worship the tools of study while ignoring the mind of the scholar. We conveniently forget that the mind uses the tools, the tool doesn't make the mind.
...
We see that if the current trajectory of the education system doesn't make space for free time for students, it isn't possible for them to delve into a multitude of subjects (even if they're interested). A few exceptions, with a strong family or financial safety net are possible, but not enough to make a change in the country or the world from the systems level, or even if it is possible, I haven't yet seen that come alive.
...
Above all, the purpose of education is to give a person the tools to lift himself up if he wishes too, & modern education has strayed from that path long ago. One could say that it is by design.
That purpose must be reinstated again & the system must be redesigned, this time prioritizing collective progress over individual net worth.
...
Education should not be gatekept by financial barriers.
...
There would be no fees, it would run on donations & teachers won't receive salary. In a way, those teachers would have an internal call towards teaching as a service. Students won't be graded on marks, but on curiosity & effectiveness in different kinds of assessments which would include education, sports & basic fitness activities at the very least. It would have a community kitchen where everyone would help each other grow food & cook, without the influence of corporatized food. That is why it is very difficult to execute under the shadow of late-stage capitalism, because there aren't enough spare resources left with common people anymore. And also, if such a school exists, then the next problem would be employability, even if the schooling is free. That is why I wrote earlier & in the previous two parts that a systemic reform is needed, not just at isolated pillars of the capitalist structure but in the entire structure. It would be difficult, yes, but what's the point of doing it if it were easy?

The ultra-rich have separated their children from the schools for common people & that is also a reason why there's such a divide in the quality of education. It is what is called 'paying a premium'. But what of those children whose parents can't pay that premium? Don't they deserve to be educated?

We must not despair. By choosing not to despair, we already win half the battle. The other half is won through persistent action.

We must understand that every child suffocated by exams is another instance of curiosity suppressed by this system.
...
And the first step is to think freely.
